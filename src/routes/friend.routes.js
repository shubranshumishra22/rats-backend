...
const { sendRequestSchema, respondRequestSchema, friendIdSchema, userIdParamSchema } = require('../validations/friend.validation');
...
router.get('/status/:userId', validate(userIdParamSchema), friendController.getFriendshipStatus);
